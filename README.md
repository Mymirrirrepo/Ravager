...
## Heroku
- Click [![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/Mymirrirrepo/Ravager) and fill the environment variables accordingly. 
